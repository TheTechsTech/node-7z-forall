...
import zFile from '../../util/esm/files.mjs';
import zReplaceNativeSeparator from '../../util/esm/replaceNativeSeparator.mjs';
import zRun from '../../util/esm/run.mjs';
        ...
        zRun(command, options)
            ...
            .progress(function (data) {
                ...
                data.split('\n').forEach(function (line) {
                    if (line.substr(0, 1) === '+') {
                        entries.push(zReplaceNativeSeparator(line.substr(2, line.length)));
                    }
                });
